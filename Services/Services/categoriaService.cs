...
namespace Services.Categoria
{
    public class categoriaService : ICategoria
    {
        ...
        public List<tbl_categoriaModel> GetCategorias(IDbConnection connection)
        {
            return (List<tbl_categoriaModel>)connection.Query<tbl_categoriaModel>("SELECT * FROM tbl_categoria");
        }
